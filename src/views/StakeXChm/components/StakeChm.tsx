...
const StakeChm: React.FC<StakeProps> = ({}) => {
  const tokenName = "CHM"
  ...
  const tokenBalance = useTokenBalance(contractAddresses.chm[97])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`CHM Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
